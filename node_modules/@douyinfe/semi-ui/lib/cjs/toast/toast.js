...
class Toast extends _baseComponent.default {
  ...
  renderIcon() {
    ...
    const iconCls = (0, _classnames.default)("".concat(prefixCls, "-icon"), (0, _concat.default)(_context = "".concat(prefixCls, "-icon-")).call(_context, type));
...
Toast.contextType = _context4.default;
Toast.propTypes = {
