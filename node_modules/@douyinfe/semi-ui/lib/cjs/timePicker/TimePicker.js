...
class TimePicker extends _baseComponent.default {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.isControlled('value') && this.props.value !== prevProps.value) {
      this.foundation.refreshProps((0, _assign.default)({}, this.props));
  ...
  getPanelElement() {
    ...
    const timePanels = [/*#__PURE__*/_react.default.createElement(_Combobox.default, (0, _assign.default)({}, this.props, {
      key: 0,
      format: format,
      isAM: isAM[0],
    ...
    if (type === _constants.strings.TYPE_TIME_RANGE_PICKER) {
      timePanels.push( /*#__PURE__*/_react.default.createElement(_Combobox.default, (0, _assign.default)({}, this.props, {
        key: 1,
        format: format,
        isAM: isAM[1],
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: wrapCls
    }, (0, _map.default)(timePanels).call(timePanels, panel => panel));
  }
  ...
  getPopupClassName() {
    ...
    }, (0, _concat.default)(_context = "".concat(prefixCls, "-panel-column-")).call(_context, selectColumnCount));
  }
  ...
  render() {
    ...
    const panelPrefix = (0, _classnames.default)({
      ...
      [(0, _concat.default)(_context2 = "".concat(prefixCls, "-panel-")).call(_context2, size)]: size
    });
    ...
    }, /*#__PURE__*/_react.default.createElement(_TimeInput.default, (0, _assign.default)({}, inputProps)))));
  }
