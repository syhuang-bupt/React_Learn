...
class Slider extends _baseComponent.default {
  ...
  render() {
    const wrapperClass = (0, _classnames.default)("".concat(prefixCls, "-wrapper"), {
      ...
      ["".concat(_constants.cssClasses.VERTICAL, "-wrapper")]: this.props.vertical,
    ...
    const sliderCls = (0, _classnames.default)({
      ...
      [_constants.cssClasses.VERTICAL]: this.props.vertical
    });
    ...
    }, this.state.min), /*#__PURE__*/_react.default.createElement("span", {
