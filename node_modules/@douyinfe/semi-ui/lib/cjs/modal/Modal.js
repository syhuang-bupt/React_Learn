...
class Modal extends _baseComponent.default {
  constructor(props) {
    ...
    this.renderDialog = () => {
      ...
      const classList = (0, _classnames.default)(className, {
        ["".concat(_constants.cssClasses.DIALOG, "-displayNone")]: keepDOM && this.state.hidden && !visible
      });
      const contentClassName = motion ? (0, _classnames.default)({
        ["".concat(_constants.cssClasses.DIALOG, "-content-animate-hide")]: !visible,
        ["".concat(_constants.cssClasses.DIALOG, "-content-animate-show")]: visible
      }) : null;
      const maskClassName = motion ? (0, _classnames.default)({
      ...
      }, /*#__PURE__*/_react.default.createElement(_ModalContent.default, (0, _assign.default)({}, restProps, {
    ...
    return (0, _assign.default)((0, _assign.default)({}, super.adapter), {
      ...
      disabledBodyScroll: () => {
        ...
        if (!getPopupContainer && this.bodyOverflow !== 'hidden') {
          ...
          document.body.style.width = (0, _concat.default)(_context = "calc(".concat(this.originBodyWith || '100%', " - ")).call(_context, this.scrollBarWidth, "px)");
        }
      },
      enabledBodyScroll: () => {
        const {
  ...
  static getScrollbarWidth() {
    if (_globalThis2.default && Object.prototype.toString.call(_globalThis2.default) === '[object Window]') {
