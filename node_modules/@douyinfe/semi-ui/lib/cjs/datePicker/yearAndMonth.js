...
class YearAndMonth extends _baseComponent.default {
  constructor(props) {
    ...
    this.state = {
      years: (0, _map.default)(_context = (0, _index2.getYears)()).call(_context, year => ({
        value: year,
        year
      })),
      months: (0, _map.default)(_context2 = (0, _fill.default)(_context3 = Array(12)).call(_context3, 0)).call(_context2, (v, idx) => ({
        value: idx + 1,
        month: idx + 1
      })),
      currentYear,
  ...
  renderColYear() {
    ...
    const currentDate = (0, _dateFns.setMonth)((0, _now.default)(), currentMonth - 1);
    const list = (0, _map.default)(years).call(years, _ref => {
      let {
        value,
        year
      } = _ref;
    ...
    return /*#__PURE__*/_react.default.createElement(_scrollItem.default, {
      ...
      list: list,
      transform: transform,
      selectedIndex: (0, _findIndex.default)(years).call(years, item => item.value === currentYear),
      type: "year",
  ...
  renderColMonth() {
    ...
    const currentDate = (0, _dateFns.setYear)((0, _now.default)(), currentYear);
    ...
    const list = (0, _map.default)(months).call(months, _ref2 => {
      let {
        value,
        month
      } = _ref2;
    ...
    const selectedIndex = (0, _findIndex.default)(list).call(list, item => item.month === currentMonth);
    return /*#__PURE__*/_react.default.createElement(_scrollItem.default, {
      ref: this.monthRef,
      cycled: monthCycled,
      list: list,
