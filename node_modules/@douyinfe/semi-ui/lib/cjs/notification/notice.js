...
class Notice extends _baseComponent.default {
  ...
  renderTypeIcon() {
    ...
    const iconCls = (0, _classnames.default)({
      ...
      [(0, _concat.default)(_context = "".concat(prefixCls, "-")).call(_context, type)]: true
    });
  ...
  render() {
    ...
    const wrapper = (0, _classnames.default)(prefixCls, className, {
      ...
      ["".concat(prefixCls, "-icon-show")]: (0, _includes.default)(types).call(types, type),
      [(0, _concat.default)(_context2 = "".concat(prefixCls, "-")).call(_context2, type)]: true,
...
Notice.contextType = _context4.default;
Notice.propTypes = {
