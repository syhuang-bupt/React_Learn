...
class Item extends _react.PureComponent {
  constructor() {
      ...
      switch (type) {
        case 'child':
          return /*#__PURE__*/_react.default.createElement(_semiIcons.IconChevronRight, {
            className: (0, _concat.default)(_context = "".concat(prefixcls, "-icon ")).call(_context, prefixcls, "-icon-expand")
          });

        case 'tick':
          return /*#__PURE__*/_react.default.createElement(_semiIcons.IconTick, {
            className: (0, _concat.default)(_context2 = "".concat(prefixcls, "-icon ")).call(_context2, prefixcls, "-icon-active")
          });
    ...
    this.highlight = searchText => {
      ...
      (0, _forEach.default)(searchText).call(searchText, (item, idx) => {
        if (typeof item === 'string' && (0, _includes2.default)(item, keyword)) {
          ...
          (0, _forEach.default)(_context4 = item.split(keyword)).call(_context4, (node, index) => {
            if (index > 0) {
              var _context5;

              content.push( /*#__PURE__*/_react.default.createElement("span", {
                className: "".concat(prefixcls, "-label-highlight"),
                key: (0, _concat.default)(_context5 = "".concat(index, "-")).call(_context5, idx)
              }, keyword));
            }
    ...
    this.renderFlattenOption = data => {
      ...
      const content = /*#__PURE__*/_react.default.createElement("ul", {
        ...
        key: 'flatten-list'
      }, (0, _map.default)(data).call(data, item => {
        const {
          searchText,
          key,
          disabled
  ...
  renderItem(renderData) {
    ...
    if (showChildItem) {
      (0, _concat.default)(content).call(content, this.renderItem(showChildItem.children, content));
    }
...
Item.contextType = _context7.default;
Item.propTypes = {
