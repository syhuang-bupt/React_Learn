...
class Breadcrumb extends _baseComponent.default {
  constructor(props) {
    ...
    this.handleCollapse = (template, itemsLen) => {
      ...
      const restItem = (0, _slice.default)(template).call(template, 1, itemsLen - 3);
    ...
    this.renderRouteItems = (items, shouldCollapse, moreTypeIsPopover) => {
      ...
      const hasRenderMore = (0, _isFunction2.default)(renderMore);
      const template = (0, _map.default)(items).call(items, (route, idx) => {
        var _context2;

        const key = route._origin.key || (0, _concat.default)(_context2 = "item-".concat(route.name || route.path, "-")).call(_context2, idx);
        const inCollapseArea = idx > 0 && idx <= restItemLength;
        return /*#__PURE__*/_react.default.createElement(_item.default, (0, _assign.default)({}, route, {
          key: key,
    ...
    this.renderList = () => {
      ...
      if (hasRoutes) {
        ...
        template = (0, _map.default)(items).call(items, (item, idx) => {
          const inCollapseArea = idx > 0 && idx <= restItemLength;
    ...
    this.onClick = (0, _bind.default)(_context3 = this.onClick).call(_context3, this);
  }
  ...
  renderPopoverMore(restItem) {
    ...
    const content = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (0, _map.default)(restItem).call(restItem, (item, idx) => /*#__PURE__*/_react.default.createElement(_react.default.Fragment, {
