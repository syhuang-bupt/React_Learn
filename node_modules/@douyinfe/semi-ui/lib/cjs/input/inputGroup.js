...
class inputGroup extends _baseComponent.default {
  ...
  render() {
    ...
    if (children) {
      ...
      inner = (0, _map.default)(_context3 = (0, _isArray.default)(children) ? children : [children]).call(_context3, (item, index) => {
        if (item) {
          const {
            onBlur: itemOnBlur,
            onFocus: itemOnFocus
          ...
          return /*#__PURE__*/_react.default.cloneElement(item, (0, _assign.default)({
            key: index,
            size,
            onBlur,
            onFocus
