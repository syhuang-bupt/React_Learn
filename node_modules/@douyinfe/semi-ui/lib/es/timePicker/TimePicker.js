...
export default class TimePicker extends BaseComponent {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.isControlled('value') && this.props.value !== prevProps.value) {
      this.foundation.refreshProps(_Object$assign({}, this.props));
  ...
  getPanelElement() {
    ...
    const timePanels = [/*#__PURE__*/React.createElement(Combobox, _Object$assign({}, this.props, {
      key: 0,
      format: format,
      isAM: isAM[0],
    ...
    if (type === strings.TYPE_TIME_RANGE_PICKER) {
      timePanels.push( /*#__PURE__*/React.createElement(Combobox, _Object$assign({}, this.props, {
        key: 1,
        format: format,
        isAM: isAM[1],
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: wrapCls
    }, _mapInstanceProperty(timePanels).call(timePanels, panel => panel));
  }
  ...
  getPopupClassName() {
    ...
    }, _concatInstanceProperty(_context = "".concat(prefixCls, "-panel-column-")).call(_context, selectColumnCount));
  }
  ...
  render() {
    ...
    const panelPrefix = classNames({
      ...
      [_concatInstanceProperty(_context2 = "".concat(prefixCls, "-panel-")).call(_context2, size)]: size
    });

    const inputProps = _Object$assign(_Object$assign({}, rest), {
      disabled,
      prefixCls,
      size,
    ...
    }, /*#__PURE__*/React.createElement(TimeInput, _Object$assign({}, inputProps)))));
  }
