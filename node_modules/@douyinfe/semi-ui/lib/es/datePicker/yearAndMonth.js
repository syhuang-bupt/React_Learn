...
class YearAndMonth extends BaseComponent {
  constructor(props) {
    ...
    this.state = {
      years: _mapInstanceProperty(_context = getYears()).call(_context, year => ({
        value: year,
        year
      })),
      months: _mapInstanceProperty(_context2 = _fillInstanceProperty(_context3 = Array(12)).call(_context3, 0)).call(_context2, (v, idx) => ({
        value: idx + 1,
        month: idx + 1
      })),
      currentYear,
  ...
  renderColYear() {
    ...
    return /*#__PURE__*/React.createElement(ScrollItem, {
      ...
      list: list,
      transform: transform,
      selectedIndex: _findIndexInstanceProperty(years).call(years, item => item.value === currentYear),
      type: "year",
  ...
  renderColMonth() {
    ...
    const currentDate = setYear(_Date$now(), currentYear);
  ...
  render() {
    ...
    }, /*#__PURE__*/React.createElement("span", null, selectDateText))), /*#__PURE__*/React.createElement(ScrollList, null, this.renderColYear(), this.renderColMonth()));
  }
