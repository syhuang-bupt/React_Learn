...
class Input extends BaseComponent {
  ...
  render() {
    ...
    const wrapperCls = cls(wrapperPrefix, className, {
      ...
      [_concatInstanceProperty(_context = "".concat(wrapperPrefix, "-")).call(_context, size)]: size
    });
...
const ForwardInput = /*#__PURE__*/React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Input, _Object$assign({}, props, {
  forwardRef: ref
})));
