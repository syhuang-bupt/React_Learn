...
class InputNumberFoundation extends _foundation.default {
  ...
  handleInputChange(value, event) {
    ...
    if (value === '') {
      ...
      if (typeof toNum === 'number' && !isNaN(toNum)) {
        ...
        const dotIndex = (0, _lastIndexOf.default)(valueAfterParser).call(valueAfterParser, '.');
        const lengthAfterDot = valueAfterParser.length - 1 - dotIndex;

        const precLength = this._getPrecLen(toNum);

        if (!precLength) {
          const dotBeginStr = dotIndex > -1 ? (0, _slice.default)(valueAfterParser).call(valueAfterParser, dotIndex) : '';
  ...
  _getPrecLen(num) {
    ...
    const idx = (0, _indexOf.default)(num).call(num, '.') + 1;
  ...
  doParse(value) {
    ...
    if (needCheckPrec && typeof value === 'string') {
      ...
      const zeroIsValid = (0, _indexOf.default)(value).call(value, '.') === -1 || (0, _indexOf.default)(value).call(value, '.') > -1 && (value === '0' || (0, _lastIndexOf.default)(value).call(value, '0') < value.length - 1);
      const dotIsValid = (0, _lastIndexOf.default)(value).call(value, '.') < value.length - 1 && (0, _filter.default)(_context = value.split('')).call(_context, v => v === '.').length < 2;
